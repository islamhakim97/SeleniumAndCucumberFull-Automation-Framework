...
public class LoginOnWindowsUsingChrome extends testBase {
	
	public LoginOnWindowsUsingChrome() throws IOException {
		super();
	}
	...
	{
		initialization("Grid");// Using Grid With Chrome and Windows Capabilities
